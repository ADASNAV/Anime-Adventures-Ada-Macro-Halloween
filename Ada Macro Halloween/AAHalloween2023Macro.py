...
def StartingRPC():
    RPC.update(state="Ada's AA Halloween Macro, starting")
    
    
def UpdateRPC():
    RPC.update(state=f"Ada's Halloween Macro, total rounds: {TotalRounds}", details="Currently macroing AA Haloween for Candy")
